...
- 由[@yxf975](https://github.com/yxf975) 基于[@ourongxing](https://github.com/ourongxing)和[chatgpt-demo](https://github.com/ddiu8081/chatgpt-demo) 开发，查看 [源码](https://github.com/yxf975/yxfChatGPT)，欢迎自部署。
- 该网站仅作为演示，不提供长期服务，网站暂时无密码，请勿滥用。
- 本项目仅限亲朋好友使用，但不接受任何付费功能请求。
